...
//       return { ...data, email }; // Include email in the returned data
//     } catch (error) {
...
//   name: 'auth',
//   initialState: { isAuthenticated: false, authToken: '', user: { email: '', name: '' } },
//   reducers: {
...
// const authSlice = createSlice({
//   name: 'auth',
//   initialState: { isAuthenticated: false, authToken: '', user: { email: '', name: '' }, users: [] },
//   reducers: {
//     setAuthData: (state, action) => {
//       state.isAuthenticated = true;
//       state.authToken = action.payload.token;
...
interface AuthState {
  ...
  users: Array<any>; // Replace 'any' with the actual type of your users
}
