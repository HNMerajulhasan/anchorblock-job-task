...
const Dashboard: React.FC = () => {
  ...
  return (
    <div>
      <h2 className='text-center py-4 text-3xl font-bold'>User Dashboard</h2>
      <div>
        <p className='font-bold my-3 text-xl text-green-700'>SignIn Email : <span className='text-lime-600'> {email}</span></p>
      </div>
      <div>
