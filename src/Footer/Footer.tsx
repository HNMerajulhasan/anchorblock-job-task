...
<footer className="bg-[#6941c6] lg:h-[23vh]  shadow ">
    <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
        <div className="sm:flex sm:items-center sm:justify-between">
            <Link to="https://merajulhasanlatestportfolio.netlify.app/" target='_blank' className="flex items-center mb-4 sm:mb-0 space-x-3 rtl:space-x-reverse">
        ...
        <span className="block text-lg  sm:text-center text-sky-400">© 2023 Designed & Developed By<Link to="https://merajulhasanlatestportfolio.netlify.app/" target='_blank' className="hover:underline text-sky-300 text-[18px] font-bold"> H.M Merajul Hasan</Link>. All Rights Reserved.</span>
    </div>
</footer>
